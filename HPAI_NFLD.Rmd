...
all_birds <- summaryBy(TotalObserved ~ CommonName, data = whole_dataset, FUN = "sum")
...
a <- ggplot() +
  ...
  geom_point(data = top4 %>% filter(Species == "NOGA"), aes(y = Lat, x = Long, colour = TotalCat), size = 1) +
  guides(colour = guide_legend(title = "Number of Carcasses"))+
  theme(panel.background = element_rect(fill = 'white', colour = 'black'), title = element_text( size = 10, face = "bold"), legend.position = "top", axis.text.x = element_text(size = 10), axis.text.y = element_text(size = 10))
...
b <- ggplot() +
  ...
  geom_polygon(data = Canada, aes(x = long, y = lat, group = group), colour = "black", fill = "lightgrey") +
  scale_colour_viridis(option = "D", discrete = T)+
  geom_point(data = top4 %>% filter(Species == "COMU"), aes(y = Lat, x = Long, colour = TotalCat), size = 1) +
...
c <- ggplot() +
  ...
  geom_polygon(data = Canada, aes(x = long, y = lat, group = group), colour = "black", fill = "lightgrey") +
  scale_colour_viridis(option = "D", discrete = T)+
  geom_point(data = top4 %>% filter(Species == "ATPU"), aes(y = Lat, x = Long, colour = TotalCat), size = 1) +
  theme(panel.background = element_rect(fill = 'white', colour = 'black'), title = element_text( size = 10, face = "bold"), legend.position = "none", axis.text.x = element_text(size = 10), axis.text.y = element_text(size = 10))
...
d <- ggplot() +
  ...
  geom_polygon(data = Canada, aes(x = long, y = lat, group = group), colour = "black", fill = "lightgrey") +
  scale_colour_viridis(option = "D", discrete = T)+
  geom_point(data = top4 %>% filter(Species == "BLKI"), aes(y = Lat, x = Long, colour = TotalCat), size = 1) +
  theme(panel.background = element_rect(fill = 'white', colour = 'black'), title = element_text( size = 10, face = "bold"), legend.position = "none", axis.text.x = element_text(size = 10), axis.text.y = element_text(size = 10))
