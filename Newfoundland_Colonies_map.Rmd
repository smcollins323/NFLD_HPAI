...
main_map <- ggplot() +
  ...
  annotate("text", cex = 2.5, x = c(-61.1, -53, -56, -62.8, -57.5, -64, -51.4, -52.1, -55.5, -54.9), y = c(47.8, 46.5, 48.5, 45.2, 52.5, 51.5, 48.3, 49.9, 46.7, 51.3), label= c("Îles-de-la-Madeleine", "Cape St. Mary's", "Newfoundland", "Nova Scotia", "Labrador", "Québec", "Baccalieu Island","Funk Island", "Lawn Islands", "Hare Bay")) +
